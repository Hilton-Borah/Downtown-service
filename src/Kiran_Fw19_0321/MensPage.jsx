...
const MensSaloon = () => {
    return <div>
        <VStack spacing="25px" >
            <Box w="75%" h="500px" border="1px solid"  >
                <HStack>
                    <Box
                        w="50%"
                        h="500px"
                    ...
                    <Box w="50%" h="500px" border="1px solid blue">
                ...
                <HStack spacing="25px">
                    <Box w="60%" h="400px" border="1px solid red">

                    </Box>
                    <Box w="40%" h="400px" border="1px solid blue" justifyContent="right">
